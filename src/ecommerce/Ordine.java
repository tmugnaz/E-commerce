...
public class Ordine {
	...
	public void info() {
		System.out.println("Ordine :"+getNome()+" Utente: "+getUtente().getCognome()+" "+getUtente().getCognome()+" Indirizzo Spedizione: "+getIndirizzoSpedizione()
							+" Indirizzo Fatturazione: "+getIndirizzoFatturazione()+" modalit‡ pagamento selezionata: "+getPagamentoSelezionato()
							+" Stato ordine: "+getStato().name()+";");
